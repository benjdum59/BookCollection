...
public final class BookJSONAccessInfo: NSCoding {
  ...
  public var pdf: BookJSONPdf?
  public var accessViewStatus: String?
  public var epub: BookJSONEpub?
  ...
  public required init(json: JSON) {
    ...
    pdf = BookJSONPdf(json: json[SerializationKeys.pdf])
    accessViewStatus = json[SerializationKeys.accessViewStatus].string
    epub = BookJSONEpub(json: json[SerializationKeys.epub])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.pdf = aDecoder.decodeObject(forKey: SerializationKeys.pdf) as? BookJSONPdf
    self.accessViewStatus = aDecoder.decodeObject(forKey: SerializationKeys.accessViewStatus) as? String
    self.epub = aDecoder.decodeObject(forKey: SerializationKeys.epub) as? BookJSONEpub
